 ...
 *   404 QR_NOT_FOUND        → "Pass not found" panel
 *   410 QR_EXPIRED          → "Pass expired" panel
 *   410 QR_CONSUMED         → "Pass already used" panel
...
import { AlertTriangle, Clock3, Loader2, ShieldAlert } from "lucide-react";
